...
class ProfileInfo(QDialog, Ui_DialogMe):
    ...
    def initUI(self):
        self.lineEditGithub.setText(
            SC.get(
                Settings.App.Info.Repo.value, "github.com\\elqabasy\\Auto-Bank"
            )
        )
        self.lineEditEmail.setText(
            SC.get(
                Settings.App.Author.Mail.value,
                "mahros.elqabasy@hotmail.com"
            )
        )
        self.lineEditPhone.setText(
            SC.get(
                Settings.App.Author.Phone.value,
                "+20 1015888272"
            )
        )
        self.lineEditAuthor.setText(
            SC.get(
                Settings.App.Author.Name.value,
                "Mahros AL-Qabasy"
            )
        )
        self.lineEditVersion.setText(
            SC.get(
                Settings.App.Info.Version.value,
                "9.9.9"
            )
        )
